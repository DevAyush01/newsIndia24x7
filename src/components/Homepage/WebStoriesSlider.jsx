        ...
        {stories.map((story) => {
          ...
          return (
            <Link
              ...
              className="flex-shrink-0 w-[140px] sm:w-[160px] md:w-[175px] transition-transform hover:scale-[1.02] duration-300"
            >
              <article className="bg-white border border-gray-200 rounded-xl overflow-hidden hover:shadow-lg transition-shadow duration-300">
                ...
                <div className="p-2.5">
                  <h3 className="text-[13px] font-semibold leading-5 line-clamp-2 text-gray-800">
                    {title}
                  </h3>
                </div>
              </article>
